...
def parse_args():
    ...
    parser.add_argument(
        '--dataset',
        default='voc2007trainval',
        help='training dataset')
    parser.add_argument(
        '--cfg_file', #dest='cfg_file', required=True,
       #default='configs/baselines/vgg16_voc2007_more.yaml',
        default='configs/baselines/vgg16_voc2007.yaml',
        help='optional config file')
    parser.add_argument(
        '--result_path',
        default='Outputs/vgg16_voc2007/Jan07-20-40-33_gpu7_step/test/model_step34999/discovery.pkl',
