...
def parse_args():
    ...
    parser.add_argument(
        '--cfg_file', #dest='cfg_file', required=True,
        default='configs/baselines/vgg16_voc2007.yaml',
        help='optional config file')

    parser.add_argument(
        '--load_ckpt', 
        default='Outputs/vgg16_voc2007/Jul07-20-40-33_gpu7_step/ckpt/model_step34999.pth',
...
if __name__ == '__main__':
    ...
    if args.dataset == "coco2014train":
        cfg.TEST.DATASETS = ('coco_2014_train',)
        cfg.MODEL.NUM_CLASSES = 80
    elif args.dataset == "coco2014val":
        cfg.TEST.DATASETS = ('coco_2014_val',)
        cfg.MODEL.NUM_CLASSES = 80
    elif args.dataset == "coco2014test":
        cfg.TEST.DATASETS = ('coco_2014_test',)
        cfg.MODEL.NUM_CLASSES = 80
